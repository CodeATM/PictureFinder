  ...
  try {
    const res = await axios.get("https://api.unsplash.com/photos/random", {
      params: {
        ...
        client_id: "p_t452A7QUpCofdR2rpkuG61WTEVOwHLMYv8MsuVG_c",
      },
    });
...
export async function fetchRelatedUnsplashImages(imageId) {
  try {
    const res = await fetch(
      `https://api.unsplash.com/photos/${imageId}/related?client_id=dthP8VNzMTvgPPCHRVAInVjlov43oenGQx8UkNn2VqE`
    );
...
export async function fetchUserImages(username) {
  try {
    const res = await fetch(
      `https://api.unsplash.com/users/${username}/photos?client_id=dthP8VNzMTvgPPCHRVAInVjlov43oenGQx8UkNn2VqE`
    );
...
export async function fetchUserLikes(username) {
  try {
    const res = await fetch(
      `https://api.unsplash.com/users/${username}/likes?client_id=dthP8VNzMTvgPPCHRVAInVjlov43oenGQx8UkNn2VqE`
    );
...
export async function fetchUserCollection(username) {
  try {
    const res = await fetch(
      `https://api.unsplash.com/users/${username}/collections?client_id=dthP8VNzMTvgPPCHRVAInVjlov43oenGQx8UkNn2VqE`
    );
...
export async function fetchUser(username) {
  try {
    const res = await fetch(
      `https://api.unsplash.com/users/${username}?client_id=dthP8VNzMTvgPPCHRVAInVjlov43oenGQx8UkNn2VqE`
    );
