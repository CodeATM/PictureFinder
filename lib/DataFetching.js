...
export async function fetchUnsplashCollections() {
  try {
    const response = await fetch(
      ...
      {
        headers: {
          Authorization: `Client-ID ${process.env.NEXT_PUBLIC_UNSPLASH_ACCESS_KEY_2}`,
        },
...
export async function fetchRelatedUnsplashImages(imageId) {
  try {
    const res = await fetch(
      `https://api.unsplash.com/photos/${imageId}/related?client_id=${process.env.UNSPLASH_ACCESS_KEY_2}`
    );
...
export async function fetchUserImages(username) {
  try {
    const res = await fetch(
      `https://api.unsplash.com/users/${username}/photos?client_id=${process.env.NEXT_PUBLIC_UNSPLASH_ACCESS_KEY}`
    );
...
export async function fetchUserLikes(username) {
  try {
    const res = await fetch(
      `https://api.unsplash.com/users/${username}/likes?client_id=${process.env.NEXT_PUBLIC_UNSPLASH_ACCESS_KEY_2}`
    );
...
export async function fetchUserCollection(username) {
  try {
    const res = await fetch(
      `https://api.unsplash.com/users/${username}/collections?client_id=${process.env.NEXT_PUBLIC_UNSPLASH_ACCESS_KEY}`
    );
...
export async function fetchUser(username) {
  try {
    const res = await fetch(
      `https://api.unsplash.com/users/${username}?client_id=${process.env.NEXT_PUBLIC_UNSPLASH_ACCESS_KEY_2}`
    );
...
export const fetchCollectionImages = async (collection) => {
  try {
    ...
    const url = `https://api.unsplash.com/collections/${collection}/photos?client_id=${process.env.NEXT_PUBLIC_UNSPLASH_ACCESS_KEY_2}`;
