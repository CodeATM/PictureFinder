...
import { FaInstagram, FaTwitter, FaLink, FaInstagramSquare } from "react-icons/fa";
    ...
    <div className="max-screen-wrapper">
      <div className="max-screen-inner">
        <div className="flex items-center space-y-4 md:space-x-4 flex-col md:flex-row">
          ...
          />
          <div>
            <h1 className="text-[#111] font-[500] text-[20px] leading-[32px] ">{name}</h1>
            {bio && <p className="text-[#838383] font-[400] text-[17px] leading-[26px] ">{bio}</p>}
          </div>
        </div>
        {location && (
          <div className=" flex gap-2 mt-2">
            ...
            <p className="text-[#838383] text-[17px] leading-[23px] font-[400] ">{location}</p>
          </div>
        )}
        {portfolio_url && (
          <div className="mt-4">
